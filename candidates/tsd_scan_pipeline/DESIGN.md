...
| `tsd_social` (Polygon news + StockTwits; X off) | Soft continuation terms + thesis; never hard-vetoes |
| `catalyst_ai` via OpenRouter (`mistral-nemo` default) | Headline → print/outlook tags; free tiers optional via env |
