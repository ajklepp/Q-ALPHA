# ============================================================
# Q-ALPHA | EXP-0010 | experiment10.py
# Polygon.io | $3K account | Fixed position sizing
...
def run_simulation(test_df, price_pivot, threshold, label=""):
    ...
    for current_date in all_dates:
        ...
        significant_positions = [
            p for p in active
            if p.open_slice_count() > 1
        ]
        active_tickers = {
            p.ticker for p in significant_positions
        }
        ...
        if (current_date in signal_lookup and
            ...
            for _, row in candidates.iterrows():
                ...
                pos_size = min(POSITION_SIZE, pool / available_slots)
...
def main():
    print("="*55)
    print("  Q-ALPHA | EXP-0010 | $3K Polygon.io Pipeline")
    print("  Running on Modal cloud")
    print("="*55)

    result = run_exp010.remote()
