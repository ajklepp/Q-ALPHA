# ============================================================
# Q-ALPHA | EXP-0012 | experiment12.py
...
TRADE_UNIVERSE = [t for t in UNIVERSE if t != "SPY"]
...
def run_exp012():
    ...
    t0 = time.time()
    print("="*55)
    print("EXP-0012: Polygon.io | $3K Dynamic Sizing + Regime Filter")
...
def main():
    print("="*55)
    print("  Q-ALPHA | EXP-0012 | $3K Dynamic Sizing + Regime Filter")
    print("  Running on Modal cloud")
    print("="*55)

    result = run_exp012.remote()
