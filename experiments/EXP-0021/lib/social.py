"""
EXP-0021 social + news velocity (Phase D1 + optional D2 X).
...
def fetch_polygon_news_velocity(
    ...
    *,
    ...
    out = {
        ...
        "news_headline_count_48h": float(n24 + n72) / 2.0,  # soft proxy when 48h not split
...
def fetch_social_bundle(
    ...
    *,
    ...
    news_ok = float(out.get("news_velocity_72h") or 0) >= 0  # always "ok" if call returned
