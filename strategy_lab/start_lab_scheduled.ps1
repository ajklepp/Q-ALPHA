...
# -----------------------------------------------------------------------------
# REGISTER (copy/paste in an elevated or normal PowerShell — you run it):
#
#   schtasks /Create /F ^
#     /TN "QAlpha Strategy Lab" ^
#     /TR "powershell.exe -NoProfile -ExecutionPolicy Bypass -File \"C:\Users\ajkle\OneDrive\Documents\Q-ALPHA\strategy_lab\start_lab_scheduled.ps1\"" ^
